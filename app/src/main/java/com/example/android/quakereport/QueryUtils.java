...
public final class QueryUtils {
    ...
    public static ArrayList<Quake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray featureArray = root.optJSONArray("Feature");


            // Loop through each feature in the array and get earthquake JSONObject at position i
            for (int i = 0; i < featureArray.length(); i++) {
                JSONObject currentEarthquake = featureArray.getJSONObject(i);
                // Get “properties” JSONObject
                JSONObject properties = currentEarthquake.getJSONObject("Properties");
                // Extract “mag” for magnitude
                String magnitude = currentEarthquake.optString("mag");
                // Extract “place” for location
                String location = currentEarthquake.optString("place");
                // Extract “time” for time
                String time = currentEarthquake.optString("time");
